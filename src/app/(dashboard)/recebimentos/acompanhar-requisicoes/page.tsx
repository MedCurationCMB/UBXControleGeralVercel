...
export default function AcompanharRequisicoesReceitaPage() {
  ...
  const handleMudarStatus = async (id: number, novoStatus: 'Aguardando Autorização' | 'Autorizado' | 'Não Autorizado') => {
    ...
    await supabase.from('requisicoes_receita').update({
      status: novoStatus,
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="page-subtitle">Todas as requisições de recebimento e o andamento até o pagamento</p>
        </div>
      ...
      {loading ? (
              ...
              <tbody>
                {filtered.map(r => (
                  <tr
                    ...
                    onClick={() => router.push(`/recebimentos/acompanhar-requisicoes/${r.id}`)}
                  >
        ...
        <div className="flex items-start gap-2 p-3 bg-blue-50 border border-blue-200 rounded-md text-sm text-blue-700">
          ...
          <p>
            Cada coluna é uma etapa da requisição até o recebimento. Enquanto nenhum pedido foi vinculado, o card pode ser
            ...
            e as colunas seguintes avançam sozinhas conforme o pedido é autorizado e recebido nas outras telas.
          </p>
        </div>
                  ...
                  {cards.map(({ req }) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() => router.push(`/recebimentos/acompanhar-requisicoes/${req.id}`)}
