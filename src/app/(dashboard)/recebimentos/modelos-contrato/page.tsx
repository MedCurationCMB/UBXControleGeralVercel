    ...
    <form onSubmit={handleUpload} className="space-y-3">
      ...
      {estilo === 'variavel' && (
        <p className="text-xs text-blue-700 bg-blue-50 border border-blue-100 rounded p-2">
          O arquivo DOCX deve conter placeholders como <code className="font-mono">{'{empresa}'}</code>, <code className="font-mono">{'{cliente}'}</code>, <code className="font-mono">{'{valor}'}</code>, etc.
        </p>
      )}
